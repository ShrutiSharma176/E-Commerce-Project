...
<html>
    ...
    <body>
        ...
        <div style="height: auto; width: 80%;border: 2px solid lightgrey;padding: 20px; margin:auto;">
            ...
            %>
            <a href="cancelOrders.jsp?ord_id=<%= ord_id%>" role="button" class="btn btn-success" style="width: 100%">Cancel Order</a>
            <%
            } else {
            %>    
            <a href="replaceOrders.jsp?ord_id=<%= ord_id%>" role="button" class="btn btn-success" style="width: 100%">Replace Order</a>
            <%
                }
            %>    
